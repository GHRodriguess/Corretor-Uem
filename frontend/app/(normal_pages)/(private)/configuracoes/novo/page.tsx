            ...
            <div className="relative container mx-auto px-4 py-10 max-w-2xl">
                <div className="mb-10">
                    ...
                    <p className="text-muted-foreground text-sm mt-1">
                        Preencha as informações para cadastrar um novo vestibular.
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    >
                        <label className="group relative flex items-center gap-4 cursor-pointer rounded-xl border border-border bg-card/40 px-4 py-3 hover:border-border/80 transition-colors">
                            ...
                            <div className="min-w-0">
                                <p className="text-sm text-foreground group-hover:opacity-90 transition-colors font-medium truncate">
                                    {form.imagem
                                        ? form.imagem.name
                                        : "Selecionar imagem"}
                                </p>
                    ...
                    <div className="flex items-center justify-end gap-3 pt-2">
                        <Link
                            href="/configuracoes"
                            className="px-5 py-2.5 rounded-xl text-sm font-medium text-muted-foreground hover:text-foreground border border-border hover:bg-muted transition-colors"
                        >
                            Cancelar
                        </Link>
                        <button
                            type="submit"
                            disabled={loading}
                            className="flex items-center gap-2 px-6 py-2.5 rounded-xl text-sm font-bold bg-primary text-primary-foreground hover:opacity-95 disabled:opacity-60 disabled:cursor-not-allowed transition-all shadow-xs"
                        >
                            {loading && (
...
function Toggle({
    ...
    return (
        ...
        >
            ...
            >
                <span
                    className={`absolute top-1 left-1 w-4 h-4 rounded-full bg-background shadow transition-transform duration-200 ${
